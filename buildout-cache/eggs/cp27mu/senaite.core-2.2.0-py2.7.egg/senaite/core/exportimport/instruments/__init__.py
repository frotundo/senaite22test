...
from lifetechnologies.gbc import gbc
from specord.uv import model_200plus
from balance.filtro import gravimetria
from perkinelmer.syngistix import icp
...
__all__ = ['abaxis.vetscan.vs2',
           ...
           'balance.filtro.gravimetria',
           'lifetechnologies.gbc.gbc',
           'perkinelmer.syngistix.icp',
           'specord.uv.model_200plus'
           ]
...
PARSERS = [
           ...
           ['Balance.filtro.gravimetria', 'balancefiltrogravimetriaParser'],
           ...
           ['perkinelmer.syngistix.icp', 'PerkinelmerSyngistixParser'],
           ...
           ['lifetechnologies.gbc.gbc', 'GbcCSVParser'],

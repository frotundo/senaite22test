...
title = "Balanza Filtro Gravimetria"
...
class BalancefiltrogravimetriaParser(InstrumentCSVResultsFileParser):
    ...
    def parse_resultsline(self, line):
        ...
        for i in range(len(clean_splitted)):
            ...
            if i < len(self._keywords):
                ...
                quantitation['DateTime'] = self.csvDate2BikaDate(
                    splitted[6])
...
class BalancefiltrogravimetriaImporter(AnalysisResultsImporter):

...
from . import SpecordCSVParser, SpecordImporter
import json
import traceback
...
def Import(context, request):
    ...
    if not hasattr(infile, 'filename'):
        ...
        if analysis:
            parser = SpecordCSVParser(infile, analysis)
        else:
    ...
    if parser:
        ...
        importer = SpecordImporter(parser=parser,
                                   context=context,
